    ...
    <div className="absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-[600ms] ease-in-out z-40">
      ...
      >
        <div className="absolute flex flex-col items-center justify-center top-0 h-full w-1/2 px-10 text-center transform transition-transform duration-[600ms] ease-in-out -translate-x-[20%]">
          <Title className="text-4xl font-bold">Bem-Vindo de Volta!</Title>
          <Paragraph className="text-white text-sm font-light leading-5 tracking-wider my-5 mx-0">Continue de onde você começou!</Paragraph>
          <Button
            className="bg-gradient-to-r from-white to-gray-100 text-orange-500 font-bold py-3 px-12 my-2 rounded-lg cursor-pointer border-none text-center uppercase transition-all duration-500 hover:bg-gradient-to-l"
        ...
        <div className="absolute right-0 flex flex-col items-center justify-center top-0 h-full w-1/2 px-10 text-center transform transition-transform duration-[600ms] ease-in-out">
          <Title className="text-4xl font-bold">Novo por aqui?</Title>
          <Paragraph className="text-white text-sm font-light leading-5 tracking-wider my-5 mx-0">Cadastre-se para uma nova aventura</Paragraph>
          <Button
            className="bg-gradient-to-r from-white to-gray-100 text-orange-500 font-bold py-3 px-12 my-2 rounded-lg cursor-pointer border-none text-center uppercase transition-all duration-500 hover:bg-gradient-to-l"

...
const Overlay = ({ onSignInClick, onSignUpClick }) => {
    return (
        <div className="absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-[600ms] ease-in-out z-40">
            <div className="bg-gradient-to-r from-orange-500 to-orange-700 text-white relative left-[-100%] h-full w-[200%] transform transition-transform duration-[600ms] ease-in-out flex" style={{backgroundImage: 'linear-gradient(to right, #e26e3d 52%, #7e4b18)'}}>
                <div className="absolute flex flex-col items-center justify-center top-0 h-full w-1/2 px-10 text-center transform transition-transform duration-[600ms] ease-in-out -translate-x-[20%]">
                    ...
                    <div className="bg-gradient-to-r from-white to-gray-100 text-purple-700 font-bold py-3 px-12 my-2 rounded-lg cursor-pointer border-none text-center uppercase transition-all duration-500 hover:bg-gradient-to-l" onClick={onSignInClick}>Entrar</div>
                </div>
                <div className="absolute right-0 flex flex-col items-center justify-center top-0 h-full w-1/2 px-10 text-center transform transition-transform duration-[600ms] ease-in-out">
                    ...
                    <div className="bg-gradient-to-r from-white to-gray-100 text-purple-700 font-bold py-3 px-12 my-2 rounded-lg cursor-pointer border-none text-center uppercase transition-all duration-500 hover:bg-gradient-to-l" onClick={onSignUpClick}>Cadastrar</div>
                </div>
            </div>
        </div>
    );

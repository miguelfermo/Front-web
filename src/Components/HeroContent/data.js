export const dataHero = [
    ...
    },
    {
        ...
        description: "Imagine um lugar onde as histórias de necessidades se encontram com a compaixão ilimitada. Aqui no Donation Compass, transformamos essa visão em realidade. Desde as vítimas de desastres naturais, até indivíduos enfrentando batalhas pessoais, cada história tem um espaço para ser ouvida e apoiada"
    },
    {
    ...
    },
    {
        ...
        description: "Junte-se a nós no Donation Compass e seja parte de uma comunidade que se preocupa. Faça a diferença na vida dessas pessoas e causas que mais precisam. Juntos, podemos criar um mundo mais solidário e compreensivo"
    },
    {
        subtitle: "Pronto para começar? Faça login ou crie uma conta agora mesmo!",
        description: "Seja bem-vindo ao Donation Compass, onde a solidariedade encontra um lar online. Junte-se a nós e faça parte dessa família especial"
    }
]
